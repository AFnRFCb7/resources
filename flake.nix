						...
						let
                            ...
                            teardown =
                                writeShellApplication
                                    {
                                        name = "teardown" ;
                                        runtimeInputs = [ coreutils flock jq log teardown-aborted teardown-processed temporary yq-go ] ;
                                        text =
                                            ''
                                                HASH="$1"
                                                CREATION_TIME="$2"
                                                ...
                                                then
                                                    ...
                                                    teardown-processed "$HASH" "$CREATION_TIME"
                                                fi
                                            '' ;
                                    } ;
                            teardown-aborted =
                                ...
                                writeShellApplication
                                    {
                                        ...
                                        runtimeImports = [ coreutils flock stall-for-cleanup teardown-completed ] ;
                                        text =
                                            ''
                                                HASH="$1"
                                                CREATION_TIME="$2"
                                                ...
                                                exec 202> "${ resources-directory }/locks/$HASH/setup.lock"
                                                flock -nx 202
                                                teardown-complete "$HASH" "$CREATION_TIME"
                                            '' ;
                                    } ;
                            temporary =
                                writeShellApplication
