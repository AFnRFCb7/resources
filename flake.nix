                                                                                                                                                                    ...
                                                                                                                                                                    pkgs.writeShellApplication
                                                                                                                                                                        {
                                                                                                                                                                            ...
                                                                                                                                                                            text =
                                                                                                                                                                                ''
                                                                                                                                                                                    jq --null-input --arg STANDARD_ERROR "1128574734324969" --arg STANDARD_OUTPUT "2926751385425387" --argjson STATUS 158 '{ "standard-error" : $STANDARD_ERROR , "standard-output" : $STANDARD_OUTPUT , "status" : $STATUS }' > /output # 1723258852938545
                                                                                                                                                                                '' ;
                                                                                                                                                                        }
                                                                                                                                                                )
                                                                                                                                                            ] ;
