                                                                                        ...
                                                                                        [
                                                                                            ...
                                                                                            (
                                                                                                writeShellApplication
                                                                                                    {
                                                                                                        name = "destroy" ;
                                                                                                        runtimeInputs = [ applications.release failure log pkgs.coreutils pkgs.findutils pkgs.flock pkgs.gnutar pkgs.inotify-tools pkgs.xz pkgs.zstd sequential trace ] ;
                                                                                                        text =
                                                                                                            visitor
                                                                                                                {
                                                                                                                    lambda =
                                                                                                                                ...
                                                                                                                                in
                                                                                                                                    ''
                                                                                                                                        ...
                                                                                                                                        then
                                                                                                                                            ...
                                                                                                                                            do
                                                                                                                                                trace 27123 7559 "We are in destroy and waiting for PID $PID INDEX=$INDEX"
                                                                                                                                                tail --follow /dev/null --pid "$PID"
                                                                                                                                                trace 27123 27859 "we are in destroy and waited for PID $PID INDEX=$INDEX"
                                                                                                                                            done
                                                                                                                                        fi
                                                                                                                                        trace 27123 30284 "We are done waiting for PID INDEX=$INDEX"
                                                                                                                                        ...
                                                                                                                                        then
                                                                                                                                            ...
                                                                                                                                            then
                                                                                                                                                ...
                                                                                                                                                trace 27123 10396 "I am about to delete the PIDs"
                                                                                                                                                ...
                                                                                                                                                trace 27123 5299 "I just deleted the PIDs"
                                                                                                                                                trace 27123 22166 "We are about to publish a message"
                                                                                                                                                jq \
                                                                                                                                                    --compact-output \
                                                                                                                                                    --null-input \
                                                                                                                                                    --arg INDEX "$INDEX" \
                                                                                                                                                            ...
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                then
                                                                                                                                                                    ...
                                                                                                                                                                    then
                                                                                                                                                                        ...
                                                                                                                                                                        touch "${ resources-directory }/release/$INDEX"
                                                                                                                                                                        tar --create --xz --file "$ARCHIVE" "${ gc-root-directory }/$INDEX" "${ resources-directory }/mounts/$INDEX" "${ resources-directory }/pids/$INDEX" "${ resources-directory }/release/$INDEX"
                                                                                                                                                                        trace 27123 3831 "I am about to remove the PIDs"
                                                                                                                                                                        rm --recursive --force "${ gc-root-directory }/$INDEX" "${ resources-directory }/mounts/$INDEX" "${ resources-directory }/pids/$INDEX" "${ resources-directory }/release/$INDEX"
                                                                                                                                                                        trace 27123 28032 "I just removed the PIDs"
                                                                                                                                                                        jq \
                                                                                                                                                                            --compact-output \
                                                                                                                                                                            --null-input \
                                                                                                                                                                            --arg INDEX "$INDEX" \
                                                                                                                                                ...
                                                                                                                                                path : value :
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        then
                                                                                                                                                            ...
                                                                                                                                                            mkdir --parents "${ gc-root-directory }/$INDEX"
                                                                                                                                                            tar --create --xz --file "$ARCHIVE" "${ gc-root-directory }/$INDEX" "${ resources-directory }/mounts/$INDEX" "${ resources-directory }/pids/$INDEX" "${ resources-directory }/release/$INDEX"
                                                                                                                                                            trace 27123 29395 "I am about to delete the PIDs"
                                                                                                                                                            rm --recursive --force "${ gc-root-directory }/$INDEX" "${ resources-directory }/mounts/$INDEX" "${ resources-directory }/pids/$INDEX" "${ resources-directory }/release/$INDEX"
                                                                                                                                                            trace 27123 21470 "I just deleted the PIDs"
