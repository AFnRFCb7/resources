                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    ${ fun false "builtins.attrValues" }
                                                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                            ${ fun false "builtins.mapAttrs" }
                                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                                    name : parameter :
                                                                                                                                                                                                                                                                        if name == "kludge" && ${ fun true "builtins.toJSON parameter" } == false then null
                                                                                                                                                                                                                                                                        else if name == "reads" && ${ fun true "builtins.toJSON parameter" } == true then null
                                                                                                                                                                                                                                                                        else if name == "standard-error" && ${ fun true "builtins.toJSON parameter" } == "" then null
                                                                                                                                                                                                                                                                        else if name == "standard-ouput" && ${ fun true "builtins.toJSON parameter" } == "" then null
                                                                                                                                                                                                                                                                        else if name == "status" && ${ fun true "builtins.toJSON parameter" } == "0" then null
                                                                                                                                                                                                                                                                        else if name == "timeout" && ${ fun true "builtins.toJSON parameter" } == "60" then null
                                                                                                                                                                                                                                                                        else "\t\t${ fun true "builtins.toJSON name" } = ${ fun true "builtins.toJSON parameter" } ;"
                                                                                                                                                                                                                                                                )
                                                                                                                                                                                                                                                                actions
                                                                                                                                                                                                                                                        )
                                                                                                                                                                                                                                                )
