                                                                                                                                                                            ...
                                                                                                                                                                            do
                                                                                                                                                                                case "$1" in
                                                                                                                                                                                    --expression)
                                                                                                                                                                                        ...
                                                                                                                                                                                        DOLLAR="$4"
                                                                                                                                                                                        EXPRESSION_0="$5"
                                                                                                                                                                                        EXPRESSION_1="${ builtins.conatStringsSep "" [ "$" "{" "EXPRESSION_0//$DOUBLE/\"" "}" ] }
                                                                                                                                                                                        EXPRESSION_2="${ builtins.conatStringsSep "" [ "$" "{" "EXPRESSION_1//$SINGLE/\'" "}" ] }
                                                                                                                                                                                        EXPRESSION="${ builtins.conatStringsSep "" [ "$" "{" "EXPRESSION_2//$DOLLAR/\$" "}" ] }
                                                                                                                                                                                        shift 2
                                                                                                                                                                                        ;;
                                                                                                                                                                                    --uuid)
                                                                                                                                                                                        UUID+=( "$2" )
