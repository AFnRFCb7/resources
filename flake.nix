                                                                                                                                                ...
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in
                                                                                                                                                        ''
                                                                                                                                                            ...
                                                                                                                                                            mkdir --parents ${ resources-directory }/invalid-init
                                                                                                                                                            mkdir --parents ${ resources-directory }/logs
                                                                                                                                                            sed -e "s#\$INDEX#$INDEX#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.toJSON path }" ${ resolve } > "${ resources-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resources-directory }/logs/$ERROR_SEQUENCE"
