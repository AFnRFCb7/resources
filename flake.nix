                                                                                                                                                ...
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in
                                                                                                                                                        ''
                                                                                                                                                            ...
                                                                                                                                                            mkdir --parents ${ resources-directory }/logs
                                                                                                                                                            sed -e "s#\$INDEX#$INDEX#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.toJSON path }" ${ resolve } > "${ resource-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resource-directory }/logs/$ERROR_SEQUENCE"
