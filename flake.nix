                                                                                                                ...
                                                                                                                ''
                                                                                                                    ...
                                                                                                                    then
                                                                                                                        ...
                                                                                                                        do
                                                                                                                            ...
                                                                                                                            OBSERVED="$( readlink --canonicalize "$LINK" )" || { STATUS="$?" && echo readlink failed "$STATUS" && exit 199 ; }
                                                                                                                        ...
                                                                                                                        echo "8741665869459463 IS RELEASABLE? $INDEX ... IS_RELEASABLE_STATUS=$IS_RELEASABLE_STATUS IS_RELEASABLE_STANDARD_ERROR=$IS_RELEASABLE_STANDARD_ERROR"
                                                                                                                                                            ...
                                                                                                                                                            pkgs.writeShellApplication
                                                                                                                                                                {
                                                                                                                                                                    ...
                                                                                                                                                                    text =
                                                                                                                                                                        ''
                                                                                                                                                                            ...
                                                                                                                                                                            TARGETS=()
                                                                                                                                                                            is_non_deterministic_regular_file()
                                                                                                                                                                            {
                                                                                                                                                                                local FILE
                                                                                                                                                                                for FILE in "${ builtins.concatStringsSep "" [ "$" "{" "NON_DETERMINISTIC_REGULAR_FILES[@]" "}" ] }"
                                                                                                                                                                                do
                                                                                                                                                                                    [[ "$FILE" == "$1" ]] && return 0
                                                                                                                                                                                done
                                                                                                                                                                                return 1
                                                                                                                                                                            ...
                                                                                                                                                                            find "${ builtins.concatStringsSep "" [ "$" "{" "TARGETS[@]" "}" ] }" \( "${ builtins.concatStringsSep "" [ "$" "{" "EXCLUSIONS[@]" "}" ] }" \) -prune -o -print | LC_ALL=C sort | while read -r NAME
                                                                                                                                                                            do
                                                                                                                                                                                ...
                                                                                                                                                                                elif [[ -f "$NAME" ]] && is_non_deterministic_regular_file "$NAME"
                                                                                                                                                                                then
                                                                                                                                                                                    jq \
                                                                                                                                                                                        --null-input \
                                                                                                                                                                                        --arg NAME "$NAME" \
                                                                                                                                                                    ...
                                                                                                                                                                    pkgs.writeShellApplication
                                                                                                                                                                        {
                                                                                                                                                                            ...
                                                                                                                                                                            text =
                                                                                                                                                                                ''
                                                                                                                                                                                    ...
                                                                                                                                                                                    force-garbage-collection
                                                                                                                                                                                    find ${ resources-directory }/mounts -type f -delete
                                                                                                                                                                                    echo -n "${ builtins.concatStringsSep "" [ "$" "{" "UUID[@]" "}" ] }" >&2
                                                                                                                                                                                '' ;
                                                                                                                                                                        }
                                                                                                                                                                )
                                                                                                                                        ...
                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                text =
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        if diff --recursive --unified "/tmp/scratch/commands/${ command-index }/expected" "/tmp/scratch/commands/${ command-index }/observed" > "/tmp/scratch/commands/${ command-index }/diff"
                                                                                                                                                        then
                                                                                                                                                            true
                                                                                                                                                        fi
                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            let
                                                                                                                                                            ...
                                                                                                                                                            "answer.nix"
                                                                                                                                                                (
                                                                                                                                                                    ${ fun false "builtins.concatStringsSep" }
                                                                                                                                                                        "\n"
                                                                                                                                                                        (
                                                                                                                                                                            ${ fun false "builtins.concatLists" }
                                                                                                                                                                                [
                                                                                                                                                                                    [ "[" ]
                                                                                                                                                                                    (
                                                                                                                                                                                        ${ fun false "builtins.map" }
                                                                                                                                                                                            (
                                                                                                                                                                                                actions :
                                                                                                                                                                                                    (
                                                                                                                                                                                                        ${ fun false "builtins.concatStringsSep" }
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        [
                                                                                                                                                                                                                            (
                                                                                                                                                                                                                                ${ fun false "builtins.concatStringsSep" }
                                                                                                                                                                                                                                    "\n"
                                                                                                                                                                                                                                    (
                                                                                                                                                                                                                                       ${ fun false "builtins.filter" }
                                                                                                                                                                                                                                            ( value : ${ fun false "builtins.typeOf" } value == "string" )
                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                    ${ fun false "builtins.attrValues" }
                                                                                                                                                                                                                                                        (
                                                                                                                                                                                                                                                            ${ fun false "builtins.mapAttrs" }
                                                                                                                                                                                                                                                                (
                                                                                                                                                                                                                                                                    name : parameter :
                                                                                                                                                                                                                                                                        if name == "kludge" && parameter == false then null
                                                                                                                                                                                                                                                                        else if name == "process" && parameter == "" then null
                                                                                                                                                                                                                                                                        else if name == "reads" && parameter == true then null
                                                                                                                                                                                                                                                                        else if name == "standard-error" && parameter == "" then null
                                                                                                                                                                                                                                                                        else if name == "standard-output" && parameter == "" then null
                                                                                                                                                                                                                                                                        else if name == "status" && parameter == 0 then null
                                                                                                                                                                                                                                                                        else if name == "timeout" && parameter == 60 then null
                                                                                                                                                                                                                                                                        else "\t\t${ fun true "name" } = ${ fun true "builtins.toJSON parameter" } ;"
                                                                                                                                                                                                                                                                )
                                                                                                                                                                                                                                                                actions
                                                                                                                                                                                                                                                        )
                                                                                                                                                                                                                                                )
                                                                                                                                                ...
                                                                                                                                                fun =
                                                                                                                                                    brace : expression :
                                                                                                                                                        if brace then "${ builtins.concatStringsSep "" [ "$" "{" " " expression " " "}" ] }"
                                                                                                                                                        else expression ;
                                                                                                                                                in
                                                                                                                                                    ''
                                                                                                                                                        # 13644 mkdir --parents ${ resources-directory }
                                                                                                                                                        ...
                                                                                                                                                        NIX_FILE="$( nix eval --raw --file "/tmp/scratch/conversion.nix" --impure )" || exit 199
                                                                                                                                                        echo "NIX_FILE=$NIX_FILE" >&2
                                                                                                                                                        cat "$NIX_FILE" > /tmp/scratch/outputs.nix
                                                                                                                                                        mkdir --parents /tmp/scratch/link
                                                                                                                                                        cat ${ builtins.toFile "name" name } > /tmp/scratch/name
