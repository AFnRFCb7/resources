                                                                                                                                                                        ...
                                                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                                                            {
                                                                                                                                                                                ...
                                                                                                                                                                                text =
                                                                                                                                                                                    ''
                                                                                                                                                                                        ...
                                                                                                                                                                                        then
                                                                                                                                                                                            find ${ resources-directory } ${ gc-roots-directory } \( -path '${ resources-directory }/log.yaml' -o -path '${ resources-directory }/pids' -o -path '${ resources-directory }/temporary' "${ builtins.concatStringsSep "" [ "$" "{" "EXCLUSIONS[@]" "}" ] }" \) -prune -o -type f,l -print | sort | while read -r FILE
                                                                                                                                                                                            do
                                                                                                                                                                                                if [[ -f "$FILE" ]]
                                                                                                                                                                                                then
