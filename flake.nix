                                                                                    ...
                                                                                    _visitor.implementation
                                                                                        {
                                                                                            ...
                                                                                            string = path : value : "'RESOURCE STRING ${ builtins.typeOf implementation } ${ implementation ( { script } : "YES" ) }'" ; # "${ implementation } ${ builtins.concatStringsSep " " arguments } < ${ builtins.toFile "standard-input" value }" ;
                                                                                        }
                                                                                        standard-input ;
                                                                                in
                                                                                    ''
