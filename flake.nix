                                                                                                                                                    ...
                                                                                                                                                    let
                                                                                                                                                        ...
                                                                                                                                                        in
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                mkdir --parents ${ resources-directory }/logs
                                                                                                                                                                sed -e "s#\$DEBUG#17962#" "s#\$HASH#$HASH#" -e "s#\$INDEX#$INDEX#" -e "s#\$SCRIPT_FILE#$SCRIPT_FILE#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) }/resolve.sh" ${ resolve } > "${ resources-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resources-directory }/logs/$ERROR_SEQUENCE"
