                                                                                                                                                                        ...
                                                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                                                            {
                                                                                                                                                                                ...
                                                                                                                                                                                text =
                                                                                                                                                                                    ''
                                                                                                                                                                                        touch ${ resources-directory }/log.yaml
                                                                                                                                                                                        touch "$DOCUMENT"
                                                                                                                                                                                        ADDITION="$( jq --null-input --argjson COMMAND_INDEX "$COMMAND_INDEX" --argjson PROCESS_INDEX "$PROCESS_INDEX" '{ "command-index" : $COMMAND_INDEX , "process-index" : $PROCESS_INDEX }' )" || exit 109
