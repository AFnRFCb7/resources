                                                                                                                                        ...
                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                text =
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        echo 1723258852938545 1369941427493491 1734937854846154 "GC_ROOT_CANDIDATES=$GC_ROOT_CANDIDATES" "RESOURCE_CANDIDATES=$RESOURCE_CANDIDATES" "CANDIDATES=$CANDIDATES" >&2
