                                                                                                                                        ...
                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                text =
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        GC_ROOT_CANDIDATES="$( find /gc-roots -mindepth 1 -maxdepth 1 -name "$INDEX" )" || exit 145
                                                                                                                                                        RESOURCE_CANDIDATES="$( find /resources -mindepth 2 -maxdepth 2 -name "$INDEX" )" || exit 177
                                                                                                                                                        CANDIDATES="$GC_ROOT_CANDIDATES $RESOURCE_CANDIDATES"
                                                                                                                                                        echo 1723258852938545 1369941427493491 1734937854846154 "INDEX=$INDEX" "GC_ROOT_CANDIDATES=$GC_ROOT_CANDIDATES" "RESOURCE_CANDIDATES=$RESOURCE_CANDIDATES" "CANDIDATES=$CANDIDATES" "$( cat /input )" >&2
                                                                                                                                                        find /resources >&2 # echo 1723258852938545 1369941427493491 9446859778517194 >&2
                                                                                                                                                        echo 1723258852938545 1369941427493491 9131922995451874 >&2
                                                                                                                                                        tar --create --file /temporary/archive.tar.xz --xz "$CANDIDATES"
