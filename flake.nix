                                                                                                                                                                        ...
                                                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                                                            {
                                                                                                                                                                                ...
                                                                                                                                                                                text =
                                                                                                                                                                                    ''
                                                                                                                                                                                        touch ${ resources-directory }/log.yaml
                                                                                                                                                                                        touch "$DOCUMENT"
                                                                                                                                                                                        # ADDITION="$( jq --null-input --arg PROCESS_INDEX "$PROCESS_INDEX '{ "process-index" : $PROCESS_INDEX }' )" || 109
                                                                                                                                                                                        yq eval --prettyPrint '. | map(del(.timestamp)) | map(del(.payload.["originator-pid"]))' ${ resources-directory }/log.yaml | yq eval --prettyPrint ". | map(.)" > "$DOCUMENT"
