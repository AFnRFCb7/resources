                                                                                                                                            ...
                                                                                                                                            pkgs.writeShellApplication
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    text =
                                                                                                                                                        ''
                                                                                                                                                            EXPECTED_HASH="$1"
                                                                                                                                                            NAMES="$( find ${ resources-directory } ${ gc-roots-directory } -exec sha512sum {} \; | sha512sum | cut --characters 1-128 )" || exit 191
                                                                                                                                                            CONTENT="$( find ${ resources-directory } ${ gc-roots-directory } -type f -exec cat {} \; | sha512sum | cut --characters 1-128 )" || exit 163
