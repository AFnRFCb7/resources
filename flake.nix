                                                                                                                                                ...
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in
                                                                                                                                                        ''
                                                                                                                                                            ...
                                                                                                                                                            mkdir --parents ${ resource-directory }/invalid-init
                                                                                                                                                            mkdir --parents ${ resource-directory }/logs
                                                                                                                                                            sed -e "s#\$INDEX#$INDEX#" -e "w${ resource-directory }/invalid-init/$INDEX/${ builtins.toJSON path }" ${ resolve } > "${ resource-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resource-directory }/logs/$ERROR_SEQUENCE"
                                                                                                                                                            chmod 0500 "${ resource-directory }/invalid-init/$INDEX/${ builtins.toJSON path }"
                                                                                                                                                        '' ;
                                                                                                                                        } ;
                                                                                                                                in ''${ application }/bin/resolve "$INDEX"'' ;
                                                                                                                    in
