                                                                                                                                            ...
                                                                                                                                            let
                                                                                                                                                in
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        cd /tmp/scratch
                                                                                                                                                        nix eval --expr 'builtins.map ( actions : builtins.concatStringsSep " ,\n" ( builtins.mapAttrs ( name : parameter : "\t${ builtins.fromJSON name } = ${ builtins.concatStringsSep "" [ "$" "{ " "builtins.fromJSON parameter" " }" ] } ) actions ) ) ( builtins.fromJSON ( builtins.readFile ./outputs.json ) )' --impure > /tmp/scratch/outputs.nix
