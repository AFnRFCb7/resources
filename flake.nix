                                                                                        ...
                                                                                        [
                                                                                            ...
                                                                                            (
                                                                                                writeShellApplication
                                                                                                    {
                                                                                                        name = "destroy" ;
                                                                                                        runtimeInputs = [ applications.release failure log pkgs.coreutils pkgs.findutils pkgs.flock pkgs.gnutar pkgs.inotify-tools pkgs.zstd sequential trace ] ;
                                                                                                        text =
                                                                                                            visitor
                                                                                                                {
                                                                                                                    lambda =
                                                                                                                                    ...
                                                                                                                                    ''
                                                                                                                                        ...
                                                                                                                                        then
                                                                                                                                            ...
                                                                                                                                            then
                                                                                                                                                ...
                                                                                                                                                ${ pkgs.find }/bin/find /home/${ config.personal.name }/resources/logs -mindepth 1 -type f -exec cat {} \;
                                                                                                                                                jq \
                                                                                                                                                    --compact-output \
                                                                                                                                                    --null-input \
                                                                                                                                                    --arg INDEX "$INDEX" \
                                                                                                                                                    ...
                                                                                                                                                    let
                                                                                                                                                            ...
                                                                                                                                                            let
                                                                                                                                                                application =
                                                                                                                                                                    pkgs.writeShellApplication
                                                                                                                                                                        {
                                                                                                                                                                            name = "resolve" ;
                                                                                                                                                                            runtimeInputs = [ failure log pkgs.coreutils sequential ] ;
                                                                                                                                                                            text =
                                                                                                                                                                                ''
                                                                                                                                                        ...
                                                                                                                                                        in
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                mkdir --parents ${ resources-directory }/logs
                                                                                                                                                                trace 17630 "before sed" 16534
                                                                                                                                                                sed -e "s#\$DEBUG#26789#" -e "s#\$HASH#$HASH#" -e "s#\$INDEX#$INDEX#" -e "s#\$SCRIPT_FILE#$SCRIPT_FILE#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) }/resolve.sh" ${ resolve } > "${ resources-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resources-directory }/logs/$ERROR_SEQUENCE"
                                                                                                                                                                trace 17630 "before chmod" 23857 >> /tmp/DEBUG
                                                                                                                                                                ...
                                                                                                                                                                trace 17630 "after chmod" 1906 >> /tmp/DEBUG
                                                                                                                                                            '' ;
                                                                                                                                            } ;
                                                                                                                                                    ...
                                                                                                                                                    let
                                                                                                                                                        ...
                                                                                                                                                        in
                                                                                                                                                            ''
                                                                                                                                                                ...
                                                                                                                                                                mkdir --parents "${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) }"
                                                                                                                                                                mkdir --parents ${ resources-directory }/logs
                                                                                                                                                                sed -e "s#\$DEBUG#23865#" -e "s#\$HASH#$HASH#" -e "s#\$INDEX#$INDEX#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) }/resolve.sh" ${ resolve } > "${ resources-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resources-directory }/logs/$ERROR_SEQUENCE"
                                                                                                                                                                chmod 0500 "${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toString path ) }/resolve.sh"
                                                                                                                                                            '' ;
                                                                                                                                            } ;
                                                                                                                                    in [ ''${ application }/bin/resolve "$HASH" "$INDEX"'' ] ;
