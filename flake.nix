                                                                                                                                    ...
                                                                                                                                    let
                                                                                                                                                ...
                                                                                                                                                init =
                                                                                                                                                    {
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    [
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        (
                                                                                                                                                                                                                            pkgs.writeShellApplication
                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                    name = "init" ;
                                                                                                                                                                                                                                    runtimeInputs = parameters_.init.targetPkgs pkgs ;
                                                                                                                                                                                                                                    text = parameters_.init.text ;
                                                                                                                                                                                                                                }
                                                                                                                                                                                                                        )
                                                                                                                                                                                                                    ] ;
                                                                                                                                                                                                                text =
                                                                                                                                                        ...
                                                                                                                                                        targetPkgs =
                                                                                                                                                            visitor
                                                                                                                                                                ...
                                                                                                                                                                parameters_.init.action.targetPkgs ;
                                                                                                                                                        text =
                                                                                                                                                            visitor
                                                                                                                                                                {
                                                                                                                                                                    lambda = path : value : value { seed = seed ; } ;
                                                                                                                                                                }
                                                                                                                                                                parameters_.init.action.text ;
                                                                                                                                                    } ;
                                                                                                                                                seed =
                                                                                                                                                    let
                                                                                                                                                        to-string =
                                                                                                                                        ...
                                                                                                                                        in
                                                                                                                                            ''
                                                                                                                                                ...
                                                                                                                                                ln --symbolic ${ parameters_.init.application } /out/init/action
                                                        ...
                                                        writeShellApplication
                                                            {
                                                                ...
                                                                text =
                                                                    ''
                                                                        ...
                                                                        EXPECTED_TARGETS='${ builtins.toJSON parameters_.targets }'
