                                                        ...
                                                        writeShellApplication
                                                            {
                                                                ...
                                                                text =
                                                                    ''
                                                                        ...
                                                                        STANDARD_ERROR="$( jq --raw-output '.["standard-error"]' "$OUTPUT_FILE" )" || exit 197
                                                                                                                                        ...
                                                                                                                                        pkgs.writeShellApplication
                                                                                                                                            {
                                                                                                                                                ...
                                                                                                                                                text =
                                                                                                                                                    ''
                                                                                                                                                        ...
                                                                                                                                                        if ${ critical } && ! diff --recursive "$SCRATCH/commands/${ command-index }/expected" "$SCRATCH/commands/${ command-index }/observed"
                                                                                                                                                        then
                                                                                                                                                            touch "$SCRATCH/commands/${ command-index }/failure"
                                                                                                                                                        fi
                                                                                                                                                    '' ;
