                                        ...
                                        resource =
                                            {
                                                ...
                                                let
                                                    store =
                                                        mkDerivation
                                                            {
                                                                installPhase = ''resource "$error" "$init" "$init_recovery" "$release" "$release_recovery" "$seed" "$targets" "$temporary"'' ;
                                                                name = "resource" ;
                                                                nativeBuildInputs =
                                                                    [
                                                                        (
                                                                                        ...
                                                                                        let
                                                                                            ...
                                                                                            in
                                                                                                ''
                                                                                                    ...
                                                                                                    mkdir --parents "$ERROR"
                                                                                                    mkdir --parents "$INIT"
                                                                                                    mkdir --parents "$INIT_RECOVERY"
                                                                                                    mkdir --parents "$RELEASE"
                                                                                                    mkdir --parents "$RELEASE_RECOVERY"
                                                                                                    mkdir --parents "$SEED"
...
#                                                                                                    touch "$RELEASE_RECOVERY"
                                                                ...
                                                                outputs = [ "error" "init" "init_recovery" "release" "release_recovery" "seed" "targets" "temporary" ] ;
                                                                src = ./. ;
                                                            } ;
                                                    resource =
                                                        writeShellApplication
