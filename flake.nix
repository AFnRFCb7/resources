                                                                                                                                ...
                                                                                                                                pkgs.writeShellApplication
                                                                                                                                    {
                                                                                                                                        ...
                                                                                                                                        text =
                                                                                                                                            ''
                                                                                                                                                ...
                                                                                                                                                cd /tmp/scratch
                                                                                                                                                nix eval --expr 'builtins.map ( value : builtins.concatStringsSep " ,\n" ( builtins.mapAttrs ( name : value : "\t${ name } = ${ builtins.fromJSON value }" ) value ) ) ( builtins.fromJSON ( builtins.readFile ./outputs.json ) )' --impure > /tmp/scratch/outputs.nix
