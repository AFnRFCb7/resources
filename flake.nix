                                                                                                                                                ...
                                                                                                                                                let
                                                                                                                                                    ...
                                                                                                                                                    in
                                                                                                                                                        ''
                                                                                                                                                            ...
                                                                                                                                                            mkdir --parents ${ resources-directory }/logs
                                                                                                                                                            sed -e "s#\$INDEX#$INDEX#" -e "w${ resources-directory }/invalid-init/$INDEX/${ builtins.concatStringsSep "/" ( builtins.map builtins.toJSON path ) }/resolve.sh" ${ resolve } > "${ resources-directory }/logs/$OUTPUT_SEQUENCE" 2> "${ resources-directory }/logs/$ERROR_SEQUENCE"
